...
The 5-minute interval with the highest average steps is **`r max.step.intvl`**.
...
The mean total number of steps taken per day is **`r avg2`** and the median is **`r med2`**.
